...
// Code from line 1 to 142 preserved — PKCE login logic
// import { useEffect, useState } from "react";
// import './App.css';
// import PlaylistCard from "./components/PlaylistCard";
// import { FiMusic, FiUser, FiLogIn, FiChevronRight, FiX } from "react-icons/fi";
...
//   // Rest of app logic, UI and additional features go below this line
//   return profile === null ? (
//     <div className="min-h-screen flex items-center justify-center p-6">
//       <div className="bg-gray-800 p-8 rounded-xl max-w-md w-full text-center border border-gray-700">
//         <h1 className="text-3xl font-bold mb-6 text-blue-400">Music Hub</h1>
...
//         <button
//           onClick={() => setDarkMode(!darkMode)}
//           className="mt-4 bg-gray-700 dark:bg-gray-300 text-white dark:text-black px-4 py-2 rounded-lg shadow transition hover:opacity-80">
//           {darkMode ? "☀️ Light" : "🌙 Dark"}
//         </button>
//       </div>
//     </div>
...
//           className="text-red-500 font-bold px-4 py-2 bg-gray-700 hover:bg-red-600 rounded">
//           Logout
//         </button>
//       </header>
